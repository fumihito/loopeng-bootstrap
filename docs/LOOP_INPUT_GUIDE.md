...
- `review: dag` for a deterministic Mermaid loop-cycle diagram with recent finding badges; `review: dag act` drills into stage findings, and the CLI supports SVG and HTML output as well.
