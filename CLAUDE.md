...
Self-family reviews must use a new session, must not review the run that session implemented, and require human TUI meta-review before intake; `--auto` leaves them incoming.
