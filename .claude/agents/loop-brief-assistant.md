...
maxTurns: 20
---
<!-- DO NOT EDIT — generated by install.py from adapters/claude/.claude/agents/loop-brief-assistant.md (kit e848f441c39d). Edit the source and run install.py --update. -->
