...
maxTurns: 20
---
<!-- DO NOT EDIT — generated by install.py from adapters/claude/.claude/agents/loop-brief-assistant.md (kit 3ebbe5c45edf). Edit the source and run install.py --update. -->
