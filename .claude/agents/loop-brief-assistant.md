...
maxTurns: 20
---
<!-- DO NOT EDIT — generated by install.py from adapters/claude/.claude/agents/loop-brief-assistant.md (kit 0fd223a5c521). Edit the source and run install.py --update. -->
