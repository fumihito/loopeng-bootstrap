...
maxTurns: 20
---
<!-- DO NOT EDIT — generated by install.py from adapters/claude/.claude/agents/loop-brief-assistant.md (kit e409c64d8f38). Edit the source and run install.py --update. -->
