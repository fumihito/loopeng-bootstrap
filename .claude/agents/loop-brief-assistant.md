...
maxTurns: 20
---
<!-- DO NOT EDIT — generated by install.py from adapters/claude/.claude/agents/loop-brief-assistant.md (kit c479e9dd7df7). Edit the source and run install.py --update. -->
